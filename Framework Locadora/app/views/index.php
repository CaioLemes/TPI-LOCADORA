...
<html lang="pt-br">
  ...
  <body id="page-top">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-8 mx-auto">
              <h1 class="brand-heading">World Video</h1>
              <p class="intro-text"> Venha e alugue seu filme! </p>
    ...
    <!-- Catalogos -->
    <section id="catalogo" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <a href="catalogo.php" class="btn btn-default btn-lg">Catálogos</a>
    ...
    <!-- Lancamento -->
    <section id="lancamento" class="download-section content-section text-center">
      <div class="container">
        <div class="col-lg-8 mx-auto">
          <a href="lancamento.php" class="btn btn-default btn-lg">Lançamentos</a>
        </div>
      </div>
    </section>
    ...
    <section id="mapa" class="content-section text-center">
      <div class="container">
        <div class="row">
          <div class="col-lg-8 mx-auto">
            <a href="catalogo.php" class="btn btn-default btn-lg">LOCALIZAÇÃO</a>
          </div>
        </div>
      </div>
    </section>
